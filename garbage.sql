...
CREATE TABLE `routes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `pickup_day` int(10) unsigned NOT NULL,
  `schedule` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `area` polygon NOT NULL,
  `areastr` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=20566 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-07-12 23:44:44
